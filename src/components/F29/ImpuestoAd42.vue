  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td colspan="12">
          Pisco, Licores, Whisky y Aguardiente (tasa 31,5%)
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Vinos, Champaña, Chichas (tasa 20,5%)
        </td>
        <td class="celda-codigo">
          32
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Bebidas analcoh&oacute;licas (tasa 10%)
        </td>
        <td class="celda-codigo">
          146
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Notas Cr&eacute;ditos emitidas Facturas
        </td>
        <td class="celda-codigo">
          546
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Total D&eacute;bitos Art. 42 D.L. 825
        </td>
        <td class="celda-codigo">
          602
        </td>
      ...
      <tr class="f29__seccion__subheader">
        ...
        <th colspan="3">
          Cr&eacute;dito imputable del per&iacute;odo
        </th>
      </tr>
      ...
      <tr>
        ...
        <td colspan="9">
          Bebidas analacoh&oacute;licas (tasa 10%)
        </td>
        <td class="celda-codigo">
          582
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Notas Cr&eacute;dito recibidas
        </td>
        <td class="celda-codigo">
          559
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Remanente Cr&eacute;dito Art. 42 mes anterior
        </td>
        <td class="celda-codigo">
          508
        </td>
      ...
      <tr>
        ...
        <td colspan="12">
          Total Cr&eacute;ditos Art. 42 D.L. 825
        </td>
        <td class="celda-codigo">
          603
        </td>
