    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>Remanente de cr&eacute;dito fiscal para el per&iacute;odo siguiente</td>
                <td class="celda-codigo">77</td>
                <td class="f29__input-wrapper"><input type="text" class="f29__input" :value="cod77" disabled/></td>
                <td>IVA determinado</td>
                <td class="celda-codigo">89</td>
                <td class="f29__input-wrapper"><input type="text" class="f29__input" :value="cod89" disabled/></td>
