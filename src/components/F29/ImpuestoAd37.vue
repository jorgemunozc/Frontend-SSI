<template>
  <table>
    <tbody>
      <tr>
        <td class="celda-linea">69</td>
        <td colspan="12">Letras e), h), i) (tasa 15%)</td>
        <td class="celda-codigo">522</td>
